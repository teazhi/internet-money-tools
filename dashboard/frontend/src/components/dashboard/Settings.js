            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-green-600 mt-3 space-y-1">
                  ...
                  <p className="text-green-500">• Uses latest Sellerboard COGS data from email</p>
                </div>
                
                {(!formData.google_linked) && (
                  <div className="text-xs text-amber-600 mt-2 p-2 bg-amber-50 rounded border border-amber-200">
                    <strong>Note:</strong> Link your Google account above to enable email access for Sellerboard COGS data.
                  </div>
                )}
              </div>
            </div>
